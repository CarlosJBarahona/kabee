...
<div class="contenido"><!--contenedor-->
            <div class="headerotros visible-md visible-lg">
        
        <div class="contmensajeotros  col-md-push-3 col-lg-push-3 col-md-6 col-lg-6 ">
          
            <div class="mensaje col-md-12 col-lg-12">
              
                  <h5 class="titulo">OTROS PRODUCTOS</h5>
       ...
       <div class="headerotros visible-sm ">
        
        <div class="contmensajeotros col-sm-push-3 col-sm-6 ">
          
            <div class="mensaje col-sm-12">
              
                  <h5 class="titulosm">OTROS PRODUCTOS</h5>
      ...
      <div class="headerotros visible-xs ">
        
        <div class="contmensajeotros   col-xs-push-2 col-xs-8">
          
            <div class="mensaje col-xs-12">
              
                  <h5 class="tituloxs">OTROS PRODUCTOS</h5>
      ...
      <div class="container contenedorpro">
        <div id="productos" class="owl-carousel owl-theme"><!--slider-->
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12contpro item"><!--contpro-->
            ...
            <a class="fancybox-effects-d " href="img/otros/seccion/1.jpg" title="Lorem ipsum dolor sit amet, consectetur adipiscing elit"><div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 imgpro"><img class="img-responsive contimg" src="img/otros/1.jpg"></div></a>
            <a class="fancybox-effects-d " href="img/otros/seccion/2.jpg" title="Lorem ipsum dolor sit amet, consectetur adipiscing elit"><div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 imgpro"><img class="img-responsive contimg" src="img/otros/2.jpg"></div></a>
            <a class="fancybox-effects-d " href="img/otros/seccion/3.jpg" title="Lorem ipsum dolor sit amet, consectetur adipiscing elit"><div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 imgpro"><img class="img-responsive contimg" src="img/otros/3.jpg"></div></a>
