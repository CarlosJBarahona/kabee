...
<body>
  ...
  <div class="contenido"><!--contenedor-->
     <div class="headerbordados visible-md visible-lg">
        ...
        <div class="contmensajebordados  col-md-push-3 col-lg-push-3 col-md-6 col-lg-6 ">
          
            <div class="mensaje col-md-12 col-lg-12">
              
                  <h5 class="titulo">BORDADOS</h5>
       ...
       <div class="headerbordados visible-sm ">
        
        <div class="contmensajebordados col-sm-push-3 col-sm-6 ">
          
            <div class="mensaje col-sm-12">
              
                  <h5 class="titulosm">BORDADOS</h5>
      ...
      <div class="headerbordados visible-xs ">
        
        <div class="contmensajebordados   col-xs-push-2 col-xs-8">
          
            <div class="mensaje col-xs-12">
              
                  <h5 class="tituloxs">BORDADOS</h5>
